...
export function PropertiesView({ onNavigate }: PropertiesViewProps) {
  ...
  const properties = [
    ...
    },
    {
      ...
      type: 'Grade-A Office',
      available: '45,000 sq ft',
      price: '₹105/sq ft',
      status: 'Available',
      trending: true,
      features: ['Grade-A', 'International Standard'],
      image: 'https://images.unsplash.com/photo-1714601344981-75e003bc5d18?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBnbGFzcyUyMG9mZmljZSUyMGJ1aWxkaW5nJTIwc2t5c2NyYXBlcnxlbnwxfHx8fDE3Njc2MzAyMTh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      amenities: ['Lounge', 'Meeting Suites', 'Banks'],
      roi: '8.8% Annual Yield',
      connectivity: 'Kharadi IT Hub',
      description: 'A global business address facilitating international trade and commerce with premium facilities.',
    },
    {
      id: 6,
      name: 'WeWork Galaxy',
      ...
      status: 'Limited',
      trending: false,
      features: ['Flexible', 'Community'],
      image: 'https://images.unsplash.com/photo-1745488018261-13afb4842790?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21tZXJjaWFsJTIwcmVhbCUyMGVzdGF0ZSUyMGNvd29ya2luZyUyMHNwYWNlJTIwaW50ZXJpb3J8ZW58MXx8fHwxNzY3NjMwMjE4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      amenities: ['Wellness Room', 'Game Lounge', 'Free Coffee'],
      roi: 'N/A',
      connectivity: 'Residency Road',
      description: 'Vibrant coworking space located in the heart of the city, perfect for startups and freelancers.',
    },
    {
      id: 7,
      ...
      type: 'Tech Park',
      available: '60,000 sq ft',
      price: '₹75/sq ft',
      status: 'Available',
      trending: false,
      features: ['SEZ', 'Campus Style'],
      image: 'https://images.unsplash.com/photo-1766740606233-6573571caa6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoaWdoJTIwdGVjaCUyMGJ1c2luZXNzJTIwcGFyayUyMGNhbXB1c3xlbnwxfHx8fDE3Njc2MzAyMTh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      amenities: ['Sports Complex', 'Food Court', 'Retail'],
      roi: '7.5% Annual Yield',
      connectivity: 'Taramani',
      description: 'Pioneering IT park in Chennai offering a complete work-live-play environment.',
    },
  ];
                ...
                <div className="bg-white shadow-xl mx-auto max-w-[210mm] min-h-[297mm] p-12 relative text-slate-900">
                  ...
                  <div className="flex justify-between items-end border-b-2 border-primary pb-6 mb-8">
                    ...
                    <div className="text-right">
                      <div className="flex items-center gap-2 text-primary font-bold text-xl mb-1">
                        <TrendingUp className="w-6 h-6" /> PropIntelix
                      </div>
                  ...
                  <div className="absolute bottom-12 left-12 right-12 border-t border-slate-200 pt-6 text-center">
                    <p className="text-sm text-slate-500">
                      Generated by PropIntelix for Internal Use Only. <br />
